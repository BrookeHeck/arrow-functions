...
// When joe.scope() is invoked, this is referring to the instance joe made from the Student prototype
// 2. What is "this" when joe.scopeArrow() is invoked?
// When joe.scopeArrow() is invoked, this refers to the window object.
// 3. Explain why "this" is different when an arrow function is used.
// This happens because arrow functions don't get assigned any new value, so it uses the value defined by the enclosing function, the window
